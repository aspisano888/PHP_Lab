...
<body>
    ...
    <div class="flex bg-white py-2  px-32 pt-[60px] pb-[40px] bg-gradient-to-r from-blue-200 to-blue-100">
        ...
        <div class="px-32">
            ...
            <div class="w-1/2 not-italic text-2xl text-black">
                <p><?php echo $pd[$i]["descripcion"]?></p>
            </div>
            <a href="./index.php?view=prestarLibro&titulo=<?php echo $pd[$i]["titulo"]?>&id=<?php echo $pd[$i]["id"]?>" >
                <button type="submit" class="btn btn-success hover:bg-blue-500 hover:text-lg font-semibold border-black mt-10 w-32">PRESTAR</button>      
            </a>
        </div>
    </div>
    <?php } ?>
