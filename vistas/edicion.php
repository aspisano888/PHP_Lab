					...
					<table class="align-center border-separate border-spacing-3  border border-slate-500">
						<thead>
							<tr class="font-[bold] text-3xl ">
								...
								<td class="text-black">Descripcion</td>
							</tr>
						</thead> 
						<tbody>
								<?php	
								...
								?>
							<tr>
								<td class="pl-[10px] text-black"><input type="hidden" class="bg-white w-[110px] border-3" value="<?php echo $pd[$i]["id"];?>" name="id"></td>
								<td class="pl-[10px] text-black"><input type="text" class="bg-white w-[110px] border-3" value="<?php echo $pd[$i]["titulo"];?>" name="titulo"> </td>
								<td class="pl-[10px] text-black"><input type="text" class="bg-white w-[110px] border-3" value="<?php echo $pd[$i]["editorial"];?>" name="editorial"> </td>
								<td class="pl-[10px] text-black"><input type="text" class="bg-white w-[110px] border-3" value="<?php echo $pd[$i]["isbn"];?>" name="isbn"> </td>
								<td class="pl-[10px] text-black"><input type="text" class="bg-white w-[110px] border-3" value="<?php echo $pd[$i]["autor"];?>" name="autor"> </td>
								<td class="pl-[10px] text-black"><input type="text" class="bg-white w-[110px] border-3" value="<?php echo $pd[$i]["descripcion"];?>" name="descripcion"> </td>
								<?php 
									}
								?>
								<td><input type="submit" value="Actualizar" class="btn btn-success hover:bg-blue-500 font-semibold border-black w-25"></td>
							<tr>
						</tfoot>
					</table>
				</div>
