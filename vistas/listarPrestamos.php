...
<html>
	...
	<body>
		...
		<div class="bg-gradient-to-r from-blue-200 pt-[60px] to-blue-100 pb-[100px]">
				...
				<table class="table table-xs">
					<thead>
						<tr class="font-[bold]  text-4xl ">
							...
							<td class="text-black">Fecha</td> 
                		</tr>
					</thead> 
					<tbody class="">
                    	<?php for($i=0;$i<count($listaPrestamo);$i++){ ?>
						<tr>
							<td class="text-2xl text-black"><?php echo $listaPrestamo[$i]["titulo"];?></td> 
							<td class="text-2xl text-black"><?php echo $listaPrestamo[$i]["fechaPrestamo"];?></td> 
						</tr>
						<?php } ?>
                	</tfoot>
            	</table>
